...
const MultiCarousel = ({ deviceType, colors }) => {
  ...
  return (
    ...
    <div>
      {colors.length === 0 && <div className="flex justify-center"><Loading /></div>}
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-11 min-h-screen gap-6">
