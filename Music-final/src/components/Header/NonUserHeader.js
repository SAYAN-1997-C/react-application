      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            {sessionStorage.getItem("mailid") !== null && <div onClick={handleLogout} className="text-orange-100 transition duration-300 text-xl px-3 pt-[0.30rem] cursor-pointer hover:text-orange-600">
            Logout
            </div>}
