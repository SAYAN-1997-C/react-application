          ...
          <div className="grid  xl:grid-cols-4 w-full md:h-screen p-3 bg-slate-900 xs:overflow-hidden">
            ...
            <div className="flex flex-col xl:col-span-2 px-5 pt-4">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                  <div className="flex flex-col">
                    ...
                    <Field
                      ...
                      type="text"
                      name="firstname"
                      className="p-2 px-3 border my-2 md:w-full rounded-lg bg-white outline-none"
                      required
                    />
              ...
              <div className="flex flex-col md:flex-row gap-3">
                ...
                <div className="flex flex-col">
                  <label htmlFor="firstname" className="text-sm text-white pb-1">
                    Password
                  </label>
                  <Field
                    // value={password}
                    ...
                    type="password"
                    name="password"
                    className="p-2 px-3 border my-1 md:w-full rounded-lg bg-white outline-none"
                    required
                  />
              ...
              <div className="flex flex-col">
                ...
                <Field
                  ...
                  className={`p-2 px-3 border-2 my-2 md:w-[79.5%] rounded-lg bg-white outline-none${
              ...
              <div className="flex  flex-col">
                <button
                  type="submit"
                  className="p-2 rounded-lg my-2 text-white bg-slate-700 hover:bg-slate-800 cursor-pointer md:w-[79.5%]"
                > 
                  Submit
                </button>
              </div>
