      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <div onClick={()=> navigate('/login')} className="text-white text-xl px-3 pt-[0.30rem] cursor-pointer">
              Login
            </div>
            {/* <Nav.Link href="/signin" className="text-white">Register</Nav.Link> */}
            <div onClick={()=> navigate('/register')} className="text-white text-xl px-3 pt-[0.30rem] cursor-pointer">
              Register
            </div>
            {/* <Nav.Link href="/about" className="text-white">About</Nav.Link> */}
            <div onClick={()=> navigate('/about')} className="text-white text-xl px-3 pt-[0.30rem] cursor-pointer">
              About
            </div>
          </Nav>
