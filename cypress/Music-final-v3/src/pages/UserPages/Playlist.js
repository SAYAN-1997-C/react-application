...
export default function Playlist() {
  ...
  console.log(favarr);
  return (
    <div className="text-white min-h-[82.8vh] text-xl">
      {favarr.length === 0 ? <p className='text-center'>Playlist is Empty !!</p> :
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-10  text-white p-4 gap-4">
