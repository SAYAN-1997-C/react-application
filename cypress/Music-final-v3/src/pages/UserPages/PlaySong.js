...
function PlaySong() {
    ...
    return (
        <div className='app-container min-h-[82.8vh] bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 background-animate'>
            <div className='grid xl:grid-cols-3 gap-6 p-4 justify-center  '>
                <div></div>
                <div className='bg-white border border-lime-500 bg-opacity-25 shadow-2xl shadow-rose-500 p-4 rounded-2xl'>
                    ...
                    <div className="rounded">
                        <img src={speaker} className=' w-[100%] anima'/>
                    </div>
