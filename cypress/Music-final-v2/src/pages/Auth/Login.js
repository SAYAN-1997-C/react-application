...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 w-full p-3 2xl:p-5  sm:min-h-[81vh] bg-slate-900 overflow-hidden">
      ...
      <Snackbar open={open} autoHideDuration={2000} onClose={handleClose}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="flex flex-col p-3 h-32">
            <label htmlFor="email" id="emailfield" className="text-xl text-white pb-1">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col p-3 h-32">
            <label htmlFor="password" id="passfield" className="text-xl text-white pb-1">
              Password
            </label>
            <input
              type="password"
