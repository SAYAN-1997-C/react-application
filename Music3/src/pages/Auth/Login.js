...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // sessionStorage.setItem("mytoken", formValues.password); //res.data.token
    // sessionStorage.setItem("mailid", formValues.email);
    ...
    service.checkCredentials(userCred).then((res) => {
      ...
      // navigate("/"); Ekhne userpage er route dibi
      navigate("/");
    ...
    // if(formValues.email === "k@c.com" ){
    //   sessionStorage.setItem("mytoken", "12345678"); //res.data.token
    //   sessionStorage.setItem("mailid", "k@c.com"); //userCred.email
    //   navigate("/");
    // }
      

    // if(sessionStorage.getItem("mailid") === 'admin@gmail.com') {
    //   navigate("/");
    // }
  };
  ...
  // console.log(sessionStorage.getItem("mailid").length);
  return (
